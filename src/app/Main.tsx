...
import maptilersdk from './config'
...
export default function Main({ layersData }: { layersData: Layer[] }) {
  ...
  useEffect(() => {
    ...
    map.current.on('load', async () => {
      ...
      setSelectedLayers(layersData.map(l => ({ ...l, display: false })))
  ...
  }, [ch.lng, ch.lat, zoom, selectedLayers, layersData])
